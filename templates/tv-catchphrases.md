...
COUNT: 100 questions (the recognizable pool is thin now; fewer, well-known lines beat more obscure ones).
...
- A second batch (~300 more) took the themes of most classic sitcoms (Cheers-era through That '70s Show, Nanny, Saved by the Bell, Family Matters, Full House, Growing Pains, Family Ties, Perfect Strangers, Good Times, Alice, Mary Tyler Moore, Partridge Family, Diff'rent Strokes, WKRP, Green Acres, Mister Ed, Patty Duke), teen-drama themes (Dawson's Creek, The O.C., Gilmore Girls, One Tree Hill, Smallville), cable-drama themes (Sopranos, CSI, Monk, True Blood, Weeds, OITNB), and cartoon themes (Pokémon, Kim Possible, Fairly OddParents, Phineas and Ferb, Captain Planet, Gummi Bears, Family Guy). It also took deeper second-tier lines from Friends, Seinfeld, The Office, Parks and Rec, Brooklyn Nine-Nine, HIMYM, Arrested Development, Always Sunny, 30 Rock, The Simpsons, SpongeBob, and South Park. Assume the widely known layer is exhausted.
- My separate Catchphrases category already asks which show many famous lines come from (game-show calls like "Survey says!", "Come on down!", "Big bucks, no whammies"; reality mottos like "Expect the unexpected" and "This is where the magic happens"; "Sit on it!", "Sock it to me!", "This is the way", "So say we all", "Truthiness", the Law & Order and Real World openings). Skip those. Also skip lines whose speaker shares the show's name (Mighty Mouse, Darkwing Duck, Dr. Phil, Naruto, Kojak, Columbo, Jimmy Neutron): asking for the show there is the same as asking for the character.
